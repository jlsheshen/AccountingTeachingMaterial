 ...
 * @author likebamboo
 */
public class ImageGroupLoadTask extends BaseTask {
    ...
    public ImageGroupLoadTask(Context context) {
        super();
        mContext = context;
        result = mGruopList;
    }

    public ImageGroupLoadTask(Context context, OnTaskResultListener listener) {
        super();
        mContext = context;
        result = mGruopList;
