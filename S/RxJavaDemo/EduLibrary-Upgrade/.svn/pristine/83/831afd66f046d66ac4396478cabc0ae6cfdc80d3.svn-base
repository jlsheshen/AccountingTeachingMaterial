...
对应的包为：com.edu.library.upgrade  - 用于webservice
		  com.edu.library.upgrade2 - 用于http
主要对应的类为：
ApkUpgradeManager 
作用：检测apk是否有新版本，如果有则提示用户下载安装（如果需要上传新版本，使用爱丁云服务器进行推送 http://cloud.edusoft.cc:8080/jsp/login.jsp）
使用示例如下：
