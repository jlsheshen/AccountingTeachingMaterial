 ...
 * 
 */
public class SoundPlayer implements android.media.MediaPlayer.OnCompletionListener {
	...
	private List<OnCompletionListener> mListeners = new ArrayList<SoundPlayer.OnCompletionListener>(1);
